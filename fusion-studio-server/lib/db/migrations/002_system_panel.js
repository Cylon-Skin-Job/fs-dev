...
exports.up = async function (knex) {
  ...
  await knex('system_tabs').insert([
    {
      ...
      label: 'CLIs',
      icon: 'terminal',
      description: 'Fusion Studio works by connecting to AI assistants that run on your machine. These assistants are called CLIs. You need at least one installed for Fusion Studio to work.',
      sort_order: 0,
    },
    {
      id: 'connectors',
      label: 'Connectors',
      icon: 'link',
      description: 'Connectors let Fusion Studio talk to services you already use, like GitLab or GitHub. When a connector is active, Fusion Studio can sync tickets, pull in issues, and keep your external tools in the loop.',
      sort_order: 1,
    },
    {
      id: 'secrets',
      label: 'Secrets',
      icon: 'key',
      description: 'Some connectors and services need passwords or tokens to work. Secrets are stored safely on your machine and are never shared with AI agents. Only Fusion Studio uses them behind the scenes.',
      sort_order: 2,
    },
    {
      id: 'llm-providers',
  ...
  await knex('cli_registry').insert([
    {
      ...
      name: 'Kimi',
      author: 'Kimi AI',
      description: 'The default AI assistant for Fusion Studio. Purpose-built for IDE integration with native wire protocol support.',
      version: '2026',
      pricing_url: null,
      docs_url: null,
  ...
  await knex('system_config').insert([
    ...
    },
    {
      ...
      section: 'Limits',
      icon: 'timer',
      description: 'How long an inactive conversation stays open before Fusion Studio pauses it. The conversation can be resumed anytime.',
