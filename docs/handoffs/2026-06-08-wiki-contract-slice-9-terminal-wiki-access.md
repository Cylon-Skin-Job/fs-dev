...
- All target workspaces have canonical `ai/views/wiki-viewer/Wiki/PAGE.md` roots.
...
```text
/Users/rccurtrightjr./projects/fs-dev/System Source Files/ai/views/wiki-viewer/Wiki
/Users/rccurtrightjr./projects/Fusion-Home/ai/views/wiki-viewer/Wiki
/Users/rccurtrightjr./projects/Fusion-Home/workspace-templates/fusion-home/ai/views/wiki-viewer/Wiki
/Users/rccurtrightjr./projects/Fusion-Home/workspace-templates/project-repo/ai/views/wiki-viewer/Wiki
/Users/rccurtrightjr./projects/Fusion-Home/workspace-templates/media-studio/ai/views/wiki-viewer/Wiki
/Users/rccurtrightjr./projects/solobooks/ai/views/wiki-viewer/Wiki
/Users/rccurtrightjr./projects/media-editor/ai/views/wiki-viewer/Wiki
...
```text
{workspaceRoot}/ai/views/wiki-viewer/Wiki
```
...
- Resolve each wiki root as `{workspaceRoot}/ai/views/wiki-viewer/Wiki` unless the input path already points directly at a `Wiki` directory.
...
```js
{
  ...
  wikiRoot: '/Users/.../ai/views/wiki-viewer/Wiki',
...
2. If omitted, default to `process.cwd()` and search for `ai/views/wiki-viewer/Wiki` under it.
...
- No output paths point at `ai/views/wiki-viewer/content`.
