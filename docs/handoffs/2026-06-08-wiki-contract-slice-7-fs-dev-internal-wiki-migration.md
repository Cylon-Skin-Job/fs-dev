...
```json
"contentDir": "ai/views/wiki-viewer/content/project",
"systemWikiDir": "ai/views/wiki-viewer/content/system"
```
...
ai/views/wiki-viewer/content/project
...
```text
ai/views/wiki-viewer/index.json
```

Target settings:

```json
"contentDir": "ai/views/wiki-viewer/Wiki",
"systemWikiDir": "ai/views/wiki-viewer/Wiki"
```
...
- `fs-dev/ai/views/wiki-viewer/Wiki/PAGE.md` exists.
