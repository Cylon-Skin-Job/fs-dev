...
```text
/Users/rccurtrightjr./projects/fs-dev/System Source Files/ai/views/system-viewer/app/app.js
/Users/rccurtrightjr./projects/fs-dev/System Source Files/ai/views/system-viewer/content/secrets/user.md
/Users/rccurtrightjr./projects/fs-dev/System Source Files/ai/views/system-viewer/content/index.json
```
...
node --check "System Source Files/ai/views/system-viewer/app/app.js"
node -e "JSON.parse(require('fs').readFileSync('System Source Files/ai/views/system-viewer/content/index.json','utf8'));"
git diff --check -- "System Source Files/ai/views/system-viewer"
```
