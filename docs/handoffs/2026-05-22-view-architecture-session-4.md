...
All seven are filed as closed tickets in `ai/views/issues-viewer/closed/`.

### Chunk D Details

- Deleted `fusion-studio-server/lib/watch/views-watcher.js` (standalone watcher redundant; workspace watcher already covers `ai/views/`)
...
**Spec location:** needs to be written — `ai/views/doc-viewer/specs/chunks/chunk-G-system-files-engine.md`
...
4. Template instantiation API: `instantiateTemplate(templateId, workspacePath)` — copies a view template into a workspace's `ai/views/`, auto-numbers IDs (`wiki-viewer-01`, `wiki-viewer-02`)
...
| Chunk G spec (to write) | `ai/views/doc-viewer/specs/chunks/chunk-G-system-files-engine.md` |
| Overview doc | `docs/FUSION_STUDIO_OVERVIEW.md` |
| System Files templates | `System Files/views/`, `System Files/ai/views/` |
...
| Ticket Index | `ai/views/issues-viewer/content/tickets.json` |
| Open Tickets | `ai/views/issues-viewer/inbox/` |
| Closed Tickets | `ai/views/issues-viewer/closed/` |
