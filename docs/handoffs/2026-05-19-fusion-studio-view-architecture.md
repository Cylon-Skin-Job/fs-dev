...
**Location:** `ai/views/doc-viewer/specs/ROADMAP.md` (734 lines, up from 518)
...
**`ai/views/issues-viewer/inbox/RCC-0071.md`**
...
**`ai/views/wiki-viewer/content/enforcement/themes-and-state/PAGE.md`**
...
- `ai/views/doc-viewer/specs/ROADMAP.md` — master spec (734 lines)
- `ai/views/wiki-viewer/content/enforcement/themes-and-state/PAGE.md` — theme/state boundary spec
...
- `ai/views/issues-viewer/content/tickets.json` — ticket index (v2.0, 8 tickets)
