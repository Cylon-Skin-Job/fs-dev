...
### 1. ROADMAP.md
**Location:** `ai/views/doc-viewer/specs/ROADMAP.md` (518 lines)
...
**Location:** `ai/views/issues-viewer/`
...
| 2 | `ai/settings/` → `ai/system/` | Phase 1.1 |
...
| 7 | `ai/system/` scope: per-workspace DB | Phase 1.1 |
...
**Per-workspace (`<workspace>/ai/system/data/`):**
...
- `ai/views/doc-viewer/specs/ROADMAP.md` — master spec
- `ai/views/wiki-viewer/content/enforcement/themes-and-state/PAGE.md` — existing theme/state spec
- `ai/views/wiki-viewer/content/enforcement/code-standards/PAGE.md` — file size/modularity rules
