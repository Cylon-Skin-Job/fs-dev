...
Universal workspace styles and design tokens.

These styles define the unified interface for a workspace. Individual views inherit these styles by default.
