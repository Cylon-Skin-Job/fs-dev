...
- Selecting a heading article shows that page and populates the right sidebar when it has child pages.
...
- The left-selected article context remains highlighted while browsing its child pages.
