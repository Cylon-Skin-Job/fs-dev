...
- [Live Rendering](001-Live_Rendering/PAGE.md) - Live streaming turn rendering, reveal completion, and why finished-turn UI is not mounted inside the live renderer.
- [History Rendering](002-History_Rendering/PAGE.md) - Completed exchange hydration and instant rendering behavior for saved chat history.
- [Turn Finalization](003-Turn_Finalization/PAGE.md) - Difference between terminal stream events, reveal completion, SQLite save, and UI completion.
