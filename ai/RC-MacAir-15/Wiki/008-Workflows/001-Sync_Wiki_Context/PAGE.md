...
4. **Write** the assembled content into the hand-written zone (above the `section-toc` markers) of `ai/<machine>/Wiki/000-Wiki_Guidance/PAGE.md`, preserving the marker block.
