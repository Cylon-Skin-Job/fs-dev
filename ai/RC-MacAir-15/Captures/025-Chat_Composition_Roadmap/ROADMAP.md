...
Deliver a composable, view-bound Fusion Studio chat system in four bounded
domains. Existing conversations migrate without transcript loss. `threadId`
...
|---:|---|---|---|
| 01 | `SPEC-01-THREAD-GROUP-FOUNDATION.md` | Thread Group persistence, lifecycle, migration, and public protocol | owner-accepted Agent Tool Provenance |
...
The Generic Component Tab Host may finish before or after SPEC-01. SPEC-02 waits
for both. Nothing in SPEC-01 depends on a tab, component resolver, or renderer
surface.
...
- all four SPECs are explicitly owner-accepted in order;
...
External Provenance and Generic Tab work retain their own owners; no chat
builder edits those in-progress worktrees or assumes their unaccepted shapes.
