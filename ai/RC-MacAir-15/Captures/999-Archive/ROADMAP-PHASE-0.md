...
- `ai/<machine>/Agents/System/*/SESSION.md` — 3 agent session configs
- `ai/<machine>/Agents/System/*/PROMPT.md` — 3 files to rename
...
| File | Line | Change |
|------|------|--------|
| `ai/<machine>/Agents/System/code-manager/SESSION.md` | 5 | `system-context: ["PROMPT.md", "MEMORY.md"]` |
| `ai/<machine>/Agents/System/ops-manager/SESSION.md` | 5 | `system-context: ["PROMPT.md", "MEMORY.md"]` |
| `ai/<machine>/Agents/System/wiki-manager/SESSION.md` | 5 | `system-context: ["PROMPT.md", "MEMORY.md"]` |

### File Renames (3 files)

```bash
mv ai/<machine>/Agents/System/code-manager/PROMPT.md ai/<machine>/Agents/System/code-manager/PROMPT.md
mv ai/<machine>/Agents/System/ops-manager/PROMPT.md ai/<machine>/Agents/System/ops-manager/PROMPT.md
mv ai/<machine>/Agents/System/wiki-manager/PROMPT.md ai/<machine>/Agents/System/wiki-manager/PROMPT.md
```
...
tools:
  ...
  restricted:
    write_file: ["ai/wiki-data/project/**", "ai/<machine>/Views/<wiki-view-folder>/runs/**"]
...
3. **Delete standalone TOOLS.md**:
   - [ ] Remove `ai/<machine>/Views/<wiki-view-folder>/TOOLS.md` (content now in SESSION.md)
