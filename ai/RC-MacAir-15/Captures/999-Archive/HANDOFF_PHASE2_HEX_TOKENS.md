...
- **App layer:** `fusion-studio-client/src/**/*.css` + `ai/<machine>/System/styles/*.css` (fs-dev project layer)
- **Fusion-Home layer:** `~/projects/Fusion-Home/ai/<machine>/System/styles/*.css`

Any new token added to `fusion-studio-client/src/styles/variables.css` must also be added to `ai/<machine>/System/styles/variables.css` (fs-dev project layer) and to `~/projects/Fusion-Home/ai/<machine>/System/styles/variables.css`. These three files must stay in sync.
...
In `fusion-studio-client/src/styles/variables.css`, `ai/<machine>/System/styles/variables.css`, and `~/projects/Fusion-Home/ai/<machine>/System/styles/variables.css`, add the following block after the `--neutral-chrome-border` line:
...
| `ai/<machine>/System/styles/views.css` | `rgba(255,255,255,0.06)`, `rgba(255,255,255,0.05)`, `rgba(0,0,0,0.5)` | `--glass-sm`, `--glass-xs`, `--overlay-md` |
| `ai/<machine>/System/styles/file-viewer.css` | `rgba(255,255,255,0.1)` | `--glass-md` |
...
**Also in `ai/<machine>/System/styles/views.css`:** `rgba(239, 68, 68, 0.1)` — this is `--status-error` at 10% alpha.
