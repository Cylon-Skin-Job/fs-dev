...
workspaceState      workspace_client_state           ai/<machine>/Views/*/index.json
├── panels          ├── panel_configs (JSON)         ai/<machine>/System/styles/themes.css
...
**Mitigation:** File watcher invalidates `panel_configs` on any `ai/<machine>/Views/` change. Client falls back to `rediscoverPanels` if `panelConfigs` is empty or invalid.
