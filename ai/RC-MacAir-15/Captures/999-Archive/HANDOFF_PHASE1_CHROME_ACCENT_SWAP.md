...
|---|---|---|
| `ai/<machine>/System/styles/doc-viewer.css` | 4 | 4 |
| `ai/<machine>/System/styles/file-viewer.css` | 3 | 3 |
| `fusion-studio-client/src/styles/animations.css` | 1 | 0 |
| `ai/<machine>/Views/doc-viewer/styles/layout.css` | 4 | 3 |
...
| `ai/<machine>/System/styles/office-viewer.css` | 4 | 4 |
...
| `ai/<machine>/System/styles/themes.css` | verify | verify |
| `fusion-studio-client/src/components/WorkspaceSwitcher.css` | verify | verify |
| `ai/<machine>/Views/<wiki-view-folder>/styles/layout.css` | verify | verify |
| `fusion-studio-client/src/components/hover-icon-modal/HoverIconModal.css` | verify | verify |
| `ai/<machine>/System/styles/views.css` | verify | verify |
...
**Exception — `ai/<machine>/System/styles/themes.css`:** This file is generated by the server from `themes.json`. After Chunk 1.1 changes the generator, re-run the theme generation to refresh this file. Do not hand-edit it. If you cannot trigger generation, note it and skip — it will be regenerated on the next server startup.
...
```
ai/<machine>/System/styles/themes.css                                         (generated — skip, see note)
ai/<machine>/System/styles/views.css
ai/<machine>/System/styles/office-viewer.css
ai/<machine>/System/styles/file-viewer.css
ai/<machine>/Views/office-viewer/styles/layout.css
ai/<machine>/Views/<wiki-view-folder>/styles/layout.css
workspace-templates/project-repo/ai/<machine>/System/styles/themes.css       (generated — skip)
workspace-templates/project-repo/ai/<machine>/System/styles/views.css
workspace-templates/project-repo/ai/<machine>/System/styles/office-viewer.css
workspace-templates/project-repo/ai/<machine>/System/styles/file-viewer.css
workspace-templates/project-repo/ai/<machine>/Views/<wiki-view-folder>/styles/layout.css
workspace-templates/project-repo/ai/<machine>/Views/office-viewer/styles/layout.css
workspace-templates/media-studio/ai/<machine>/System/styles/themes.css       (generated — skip)
workspace-templates/media-studio/ai/<machine>/System/styles/views.css
workspace-templates/media-studio/ai/<machine>/System/styles/office-viewer.css
workspace-templates/media-studio/ai/<machine>/System/styles/file-viewer.css
workspace-templates/media-studio/ai/<machine>/Views/<wiki-view-folder>/styles/layout.css
workspace-templates/media-studio/ai/<machine>/Views/office-viewer/styles/layout.css
workspace-templates/fusion-home/ai/<machine>/System/styles/themes.css        (generated — skip)
workspace-templates/fusion-home/ai/<machine>/System/styles/views.css
workspace-templates/fusion-home/ai/<machine>/System/styles/office-viewer.css
workspace-templates/fusion-home/ai/<machine>/System/styles/file-viewer.css
workspace-templates/fusion-home/ai/<machine>/Views/<wiki-view-folder>/styles/layout.css
workspace-templates/fusion-home/ai/<machine>/Views/office-viewer/styles/layout.css
```
...
**File:** `ai/<machine>/Wiki/enforcement/themes-and-state/PAGE.md`
...
Both `fs-dev/ai/<machine>/Views/<wiki-view-folder>/styles/themes.css` and `Fusion-Home/ai/<machine>/Views/<wiki-view-folder>/styles/themes.css` contain:
 ...
 * ai/<machine>/Views/<wiki-view-folder>/styles/themes.css
 *
