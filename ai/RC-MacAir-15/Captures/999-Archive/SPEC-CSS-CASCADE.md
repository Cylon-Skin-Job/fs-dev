...
```
1. ai/<machine>/System/styles/styles.css                          ← system base
2. ai/<machine>/System/styles/styles.css                     ← all-views override
3. ai/<machine>/Views/{current-view}/settings/styles.css      ← view-specific override
4. ai/<machine>/Views/{view}/agents/{agent}/settings/styles.css  ← agent-specific override
```
...
The system base (`ai/<machine>/System/styles/styles.css`) defines CSS custom properties that all other layers reference:
...
Given a context path (e.g., `ai/<machine>/Data/File-Viewer/agents/kimi`):

1. Start at `ai/<machine>/System/styles/styles.css`
...
```html
<style data-layer="system">/* ai/<machine>/System/styles/styles.css */</style>
<style data-layer="all-views">/* ai/<machine>/System/styles/styles.css */</style>
<style data-layer="view" data-view="file-viewer">/* view-specific */</style>
...
1. Extract base theme from `variables.css` + `index.css` into `ai/<machine>/System/styles/styles.css`
