...
Make `ai/<machine>/System/config/cli.json` the single authority for:
...
```text
System Source Files/ai/<machine>/System/config/cli.json
```
...
```bash
grep -R "\"defaultHarness\".*\"opencode\"\\|\"opencode\"" -n ai/<machine>/System/config/cli.json "System Source Files/ai/<machine>/System/config/cli.json"
...
```bash
git diff --check -- fusion-studio-server/lib/cli-config fusion-studio-server/lib/thread fusion-studio-server/test fusion-studio-client/src ai/<machine>/System/config/cli.json "System Source Files/ai/<machine>/System/config/cli.json" docs/handoffs
```
