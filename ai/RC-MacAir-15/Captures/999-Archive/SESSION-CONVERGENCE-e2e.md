...
```bash
ls ai/<machine>/Wiki/system-tools/secrets-manager/
```
...
```bash
grep -F "secrets-manager" ai/<machine>/Wiki/system-tools/index.json
grep -F "system-tools/secrets-manager" ai/<machine>/Wiki/topics.json
```
