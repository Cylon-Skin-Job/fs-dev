...
### 1. `ai/<machine>/Wiki/system-tools/secrets-manager/PAGE.md` (new)
...
### 2. `ai/<machine>/Wiki/system-tools/secrets-manager/index.json` (new)
...
### 3. `ai/<machine>/Wiki/system-tools/secrets-manager/LOG.md` (new)
...
### 4. `ai/<machine>/Wiki/system-tools/index.json` (modify)
...
### 5. `ai/<machine>/Wiki/topics.json` (modify)
...
1. **Three new files exist.** `PAGE.md`, `index.json`, `LOG.md` under `ai/<machine>/Wiki/system-tools/secrets-manager/`.
