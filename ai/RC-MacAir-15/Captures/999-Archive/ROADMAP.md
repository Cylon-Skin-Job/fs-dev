...
- [ ] Write to `ai/<machine>/Views/{workspace}/chat/threads/{username}/THREAD_NAME.md`
...
### 3.4 Change Ledger
- [ ] `ai/<machine>/System/change-ledger.json` — every agent file change logged with thread + message ID
