...
Convert `System Source Files/ai/<machine>/Views/wiki-viewer` into the canonical shippable system-modification reference wiki using the new `Wiki/` + `PAGE.md` contract.
...
```text
System Source Files/ai/<machine>/Wiki
ai/<machine>/Wiki/system/Text-To-Speech/Rules
...
- `fusion-studio-server/lib/resources/resolver.js` points Text-To-Speech rules at `System Source Files/ai/<machine>/Wiki/system/Text-To-Speech/Rules`.
...
```text
System Source Files/ai/<machine>/Wiki/PAGE.md
```
...
- `System Source Files/ai/<machine>/Wiki/PAGE.md` exists.
