...
8. **External stylesheet exists**: `ai/<machine>/System/styles/styles/views.css` has 165 unprefixed classes, loaded via `main.tsx` import. Not touched by SPEC-18. None of its selectors match `.robin-*` or `.rv-robin-*`.
...
| `ai/<machine>/System/styles/styles/views.css` | 165 classes | External stylesheet |
...
- **Do not touch `ai/<machine>/System/styles/styles/views.css`.**
