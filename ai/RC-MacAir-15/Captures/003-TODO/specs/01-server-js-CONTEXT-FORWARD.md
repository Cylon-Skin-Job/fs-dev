...
const AI_PANELS_PATH = ...;              // resolved ai/<machine>/Views/ path
```
...
After compacting:
1. User will reference this file: `ai/<machine>/Captures/003-TODO/specs/01-server-js-CONTEXT-FORWARD.md`
...
4. Re-read `ai/<machine>/Captures/003-TODO/specs/01-server-js-decomposition.md` (the original spec) for the gotchas section
