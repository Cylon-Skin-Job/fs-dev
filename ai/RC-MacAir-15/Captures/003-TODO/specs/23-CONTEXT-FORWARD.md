...
- `ai/<machine>/Wiki/enforcement/code-standards/PAGE.md` — code standards. **Read before writing any code.** One job per file, layer as little as possible, delete don't deprecate.
...
1. User references this file: `ai/<machine>/Captures/003-TODO/specs/23-CONTEXT-FORWARD.md`
...
5. Read `ai/<machine>/Wiki/enforcement/code-standards/PAGE.md`
