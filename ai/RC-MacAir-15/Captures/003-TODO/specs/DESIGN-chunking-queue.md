...
16. **Connect this to the existing "universal send/receive syntax" todo.** The interpreter pattern is the same one — this design extends it to also carry tier information. See `ai/<machine>/Wiki/project/wire-protocol/PAGE.md`.
