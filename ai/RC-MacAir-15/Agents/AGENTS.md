...
1. Tickets are created in `ai/RC-MacAir-15/Issues/inbox/` as `RCC-NNNN.md`
...
- **Wiki:** `ai/RC-MacAir-15/Wiki/` — folder-first `PAGE.md` documentation
- **Tickets:** `ai/RC-MacAir-15/Issues/` — board state via `content/tickets.json`, individual tickets as `RCC-NNNN.md` in `inbox/`, `open/`, `complete/`, `archive/`
- **Registry:** `ai/RC-MacAir-15/Agents/registry.json` — maps agent IDs to folder paths and current status
