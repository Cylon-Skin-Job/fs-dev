---
name: Fusion Restart
description: Fusion Home restart script behavior and when to use it for chat validation.
metadata:
  incoming-edges:
...
The Fusion Home restart script is outside this repository:
...
Because it opens a GUI app and lives outside `fs-dev`, tool runs may require
approval.
