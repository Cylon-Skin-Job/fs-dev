...
**Pointer files:** For cases where content lives outside `ai/views/` (e.g., file-viewer pointing to the project repo root), use a `CONTENT.md` with a path declaration instead of symlinking into yourself:
