...
2. **`ai/views/doc-viewer/content/todo/specs/24-chat-simplification.md`** — parent spec. Understand which phases are deferred.
3. **`ai/views/doc-viewer/content/todo/specs/24a-chat-simplification-id-format.md`** — the precursor that introduced timestamp thread IDs. You build on top of its ID format.
4. **`ai/views/doc-viewer/content/todo/specs/25-frontmatter-separation-of-concerns.md`** — the `lib/frontmatter/` module you'll consume.
