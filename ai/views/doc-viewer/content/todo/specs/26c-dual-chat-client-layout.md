...
2. **`ai/views/doc-viewer/content/todo/specs/26a-dual-chat-data-model.md`** — what 26a delivered.
3. **`ai/views/doc-viewer/content/todo/specs/26b-dual-chat-routing-layer.md`** — what 26b delivered, especially the wire protocol scope field.
...
4. **Create a view thread.** Click "New Thread" in the RIGHT sidebar. Pick a harness. Send a message.
   ...
   - Filesystem: file lands at `ai/views/file-viewer/chat/threads/<user>/<id>.md`
