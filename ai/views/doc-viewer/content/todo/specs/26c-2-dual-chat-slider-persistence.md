...
2. **`ai/views/doc-viewer/content/todo/specs/26a-dual-chat-data-model.md`** — understand the data model that the scope infrastructure rests on.
3. **`ai/views/doc-viewer/content/todo/specs/26b-dual-chat-routing-layer.md`** — understand the server routing.
4. **`ai/views/doc-viewer/content/todo/specs/26c-dual-chat-client-layout.md`** — understand what 26c delivered (and what you're partially undoing).
...
16. ```bash
    cat /Users/rccurtrightjr./projects/open-robin/ai/views/file-viewer/state/rccurtrightjr..json
    ```
