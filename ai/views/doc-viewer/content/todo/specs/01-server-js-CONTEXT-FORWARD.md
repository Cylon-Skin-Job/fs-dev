...
After compacting:
1. User will reference this file: `ai/views/doc-viewer/content/todo/specs/01-server-js-CONTEXT-FORWARD.md`
...
4. Re-read `ai/views/doc-viewer/content/todo/specs/01-server-js-decomposition.md` (the original spec) for the gotchas section
