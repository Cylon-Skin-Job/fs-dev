...
When changing templates, registry behavior, or V2 view discovery, update the main Workspaces And Views pages first. Keep this page as a pointer instead of duplicating architecture details here.
