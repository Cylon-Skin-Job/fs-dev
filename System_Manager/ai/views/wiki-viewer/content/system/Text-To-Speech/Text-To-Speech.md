...
See [Mic Integration](Inputs_&_Flows/Mic_Integration.md) for the UI flow and warmup boundary.
...
See [Clean Up](Inputs_&_Flows/Clean_Up.md) for the deterministic cleanup layer and editable rules.
