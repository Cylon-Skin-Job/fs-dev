...
Folder-backed React views use local viewer search over the existing file tree/content cache. Shared indexing, loading, and ranking live in `useViewerSearchIndex.ts`; per-view adapters declare roots and exclusions.
