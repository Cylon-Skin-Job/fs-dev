...
This is not browser/web search, and it is not the terminal wiki scanner. Browser/web search belongs to [Browser](../005-Browser/PAGE.md). Wiki-specific terminal discovery belongs to [Wiki View](../004-Wiki_View/PAGE.md).
