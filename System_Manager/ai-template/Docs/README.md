...
Workspace document work product: captures, draft specs, todos, playground notes, assets, screenshots, and other document-like material displayed by document-oriented views.
...
Only files inside row folders become tiles. Root-level files directly under `Docs/` do not render as document tiles.
